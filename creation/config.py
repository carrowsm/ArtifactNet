...
log_dir = "/cluster/home/carrowsm/logs/artifact_net/create/"
...
parser.add_argument("--label_path", default=label_path, type=str, help="Path to CSV containing image labels")

parser.add_argument("--data_type", default="phantom", type=str,
help="'phantom' if we are using artificial input images, 'patient' if we are using patient CT scans.")
...
parser.add_argument("--test", action='store_true',
                    help="If the test option is given, code will only process a few images.")
